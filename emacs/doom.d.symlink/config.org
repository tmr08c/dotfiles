...
(set-email-account! "personal"
  '((mu4e-sent-folder       . "/personal/[Gmail]/Sent Mail")
    ...
    (mu4e-refile-folder     . "/personal/Processed")
...
;; https://github.com/doomemacs/doomemacs/issues/6439
(after! auth-source
  (setq auth-sources (nreverse auth-sources)))
#+end_src

With the mu4e mode enabled, DOOM's modeline will be updated to include a notification section which shows the number of unread emails.  I don't want to think about that most of the time, so let's turn it off.
