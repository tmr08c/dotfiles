...
** Copilot.el
repo :: https://github.com/zerolfx/copilot.el
...
;;               ("C-<tab>" . 'copilot-accept-completion-by-word)))
#+end_src
*** TODO Explore additional or alternative keybindings
- [[https://github.com/zerolfx/copilot.el/issues/103][This thread]] has some suggestions
- [[https://robert.kra.hn/posts/2023-02-22-copilot-emacs-setup/][This post]] has examples (possibly mentioned in above thread), but also covers usage, so is worth reading
** [[https://github.com/Exafunction/codeium.el#-installation-options][codeium.el]]
...
(use-package! codeium
    ...
    (setq codeium/metadata/api_key "f123009c-9630-465f-bab9-24bbd13d861b")
...
#+end_src
*** Overwrite company config to match suggestion to see if it helps
#+begin_src elisp
