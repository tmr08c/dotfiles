...
**** Elixir (TS) Mode
The current DOOM module (<2024-04-13 Sat>). Using the DOOM module config as the base and [[https://github.com/cullan/doom-elixir-ts][this repo]] as inspiration, set up [[https://github.com/wkirschbaum/elixir-ts-mode][elixir-ts-mode]].
